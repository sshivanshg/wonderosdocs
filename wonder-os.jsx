...
export default function WonderOSMobile() {
  ...
  const uxFlows = {
    onboarding: {
      label: "Onboarding", color: "#a78bfa", steps: [
        {
          title: "Sign Up", els: [
    ...
    configurator: {
      label: "Configurator", color: "#60a5fa", steps: [
        {
          title: "Template", els: [
    ...
    dashboard: {
      label: "Dashboard", color: "#fb923c", steps: [
        {
          title: "Home", els: [
    ...
    billing: {
      label: "Billing", color: "#34d399", steps: [
        {
          title: "Plans", els: [
  ...
  // export default function WonderOSMobile() { // moved to top
